...
public interface ProducerRepository extends JpaRepository<Producer, Long>{
	...
	/**
	 * Busca o menor intervalo entre dois premios de um produtor
	 * @return
	 */
	@Query(
		"select "
		+ " min("
		+ "     (select "
		+ "         min(movie2.year) " // query para buscar o proximo premio
		+ "     from "
		+ "          Producer producer2 "
		+ "            join producer2.movies movie2 "
		+ "     where "
	...
	Long findMinInterval();
	
	/**
	 * Busca o maior intervalo entre dois premios de um produtor
	 * @return
	 */
	@Query(
			"select "
